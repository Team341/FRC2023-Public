...
public class BottomTwoHalfCycleBlueFling extends SequentialCommandGroup {
        /** Creates a new RedBottom2Cycle. */
        public BottomTwoHalfCycleBlueFling(Swerve mDrivebase, Shoulder mShoulder, Wrist mWrist, BeltDrivenExtension mBelt,
                ...
                addCommands(
                                ...
                                new ParallelDeadlineGroup(
                                                new SequentialCommandGroup(
                                                                ...
                                                                new FollowTrajectory(mDrivebase,
                                                                                Autos.BlueBottom2CycleTag.get(0),
                                                                                "Part 1",
                                                                                true, true)),
                                                new SequentialCommandGroup(
                                                                new ArmStateMachine(mShoulder, mWrist, mBelt, mIntake,
                                ...
                                new ParallelDeadlineGroup(new IntakePiece(mIntake),
                                                new DriveToPositionAbsolute(mDrivebase, () -> new Pose2d(
                                                                Constants.Field.BLUE_BOTTOM_PIECE_FIELD_LOCATION,
                                                                new Rotation2d())),
                                                new ArmStateMachine(mShoulder, mWrist, mBelt, mIntake,
                                ...
                                new ParallelDeadlineGroup(
                                                new FollowTrajectory(mDrivebase,
                                                                Autos.BlueBottom2Cycle.get(1), "Part 4",
                                                                true, false),
                                ...
                                new ParallelDeadlineGroup(
                                                new SequentialCommandGroup(
                                                                new WaitCommand(0.5),
                                                                new FollowTrajectory(mDrivebase,
                                                                                Autos.BlueBottom2Cycle.get(2), "Part 4",
                                                                                true, false)
                                ...
                                new ParallelDeadlineGroup(new IntakePiece(mIntake),
                                                new DriveToPositionAbsolute(mDrivebase, () -> new Pose2d(
                                                                Constants.Field.BLUE_MID_BOTTOM_PIECE_FIELD_LOCATION,
                                                                new Rotation2d())),
                                                new ArmStateMachine(mShoulder, mWrist, mBelt, mIntake,
                                                                Constants.ArmPoses.INTAKE_POSITION_CONE, false))
                                                .withTimeout(3.0),
                                                new ParallelDeadlineGroup(
                                                        new SequentialCommandGroup(
                                                                        new FollowTrajectory(mDrivebase,
                                                                                        isBlue ? Autos.PickupToFlingBottomBlue :  Autos.PickupToFlingBottomRed,
                                                                                        "Part 1",
                                                                                        true, false),
