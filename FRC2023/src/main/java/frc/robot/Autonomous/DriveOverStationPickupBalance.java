...
public class DriveOverStationPickupBalance extends SequentialCommandGroup {
        /** Creates a new RedBottom2Cycle. */
        public DriveOverStationPickupBalance(Swerve mDrivebase, Shoulder mShoulder, Wrist mWrist,
                        BeltDrivenExtension mBelt,
                        Intake mIntake, Catapult mCatapult, boolean isBlue, boolean noLock) {
                Command c = noLock ? new DriveBackwardAndLevel(mDrivebase, true, noLock)
                                : new DriveBackwardAndLevel(mDrivebase, true);
                addCommands(

                                new LaunchCubeHighStart(mDrivebase, mShoulder, mWrist, mBelt, mIntake, mCatapult),
                                ...
                                new ParallelDeadlineGroup(
                                                new FollowTrajectory(mDrivebase,
                                                                isBlue ? Autos.ShiftAndPickBlue : Autos.ShiftAndPickRed,
                                                                getName(), false, true),
        ...
        public DriveOverStationPickupBalance(Swerve mDrivebase, Shoulder mShoulder, Wrist mWrist,
                ...
                Command c = (noLock && forwards) ? new SequentialCommandGroup(
                                ...
                                new ResetGyro(mDrivebase, 180.0)) : new DriveBackwardAndLevel(mDrivebase, true);
                addCommands(
                                ...
                                new ParallelDeadlineGroup(
                                                ...
                                                new ArmStateMachine(mShoulder, mWrist, mBelt, mIntake,
                                                                ...
                                                                false))
                                                .withTimeout(3.),
                                new ParallelDeadlineGroup(new TurnToAngle(mDrivebase, 180.0),
                                                new ArmStateMachine(mShoulder, mWrist, mBelt, mIntake,
                                                                Constants.ArmPoses.STOW, false)),
