...
public class BottomPickAndBalanceTag extends SequentialCommandGroup {
        /** Creates a new RedBottom2Cycle. */
        public BottomPickAndBalanceTag(Swerve mDrivebase, Shoulder mShoulder, Wrist mWrist,
                ...
                addCommands(
                                ...
                                new ParallelDeadlineGroup(new IntakePiece(mIntake),
                                                ...
                                                .withTimeout(3.0),
                                new ParallelDeadlineGroup(new SequentialCommandGroup(
                                                new FollowTrajectory(mDrivebase, isBlue ? Autos.BlueBottomIntakeToBalance : Autos.RedBottomIntakeToBalance,
                                                                "Part 4",
                                                                true, true),
