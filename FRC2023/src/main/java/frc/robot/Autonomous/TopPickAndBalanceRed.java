...
public class TopPickAndBalanceRed extends SequentialCommandGroup {
        /** Creates a new RedBottom2Cycle. */
        public TopPickAndBalanceRed(Swerve mDrivebase, Shoulder mShoulder, Wrist mWrist, BeltDrivenExtension mBelt,
                        Intake mIntake) {
                ...
                addCommands(
                                ...
                                new ParallelDeadlineGroup(new SequentialCommandGroup(
                                                new FollowTrajectory(mDrivebase, Autos.RedTopIntakeToBalance, "Part 2",
                                                                true, false),
