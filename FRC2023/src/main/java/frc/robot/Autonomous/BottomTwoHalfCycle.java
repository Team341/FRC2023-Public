...
public class BottomTwoHalfCycle extends SequentialCommandGroup {
        /** Creates a new RedBottom2Cycle. */
        public BottomTwoHalfCycle(Swerve mDrivebase, Shoulder mShoulder, Wrist mWrist, BeltDrivenExtension mBelt,
                ...
                addCommands(
                                ...
                                new ParallelRaceGroup(
                                                ...
                                                new FollowTrajectory(mDrivebase,
                                                                isBlue ? Autos.BlueBottomMidPickup.get(0) : Autos.RedBottomMidPickup.get(0),
                                                                "Part 4",
                                                                true, true),
                                                new SequentialCommandGroup(
                                ...
                                new ParallelDeadlineGroup(
                                                ...
                                                new FollowTrajectory(mDrivebase,
                                                                isBlue ? Autos.BlueBottomMidPickup.get(1) : Autos.RedBottomMidPickup.get(1),
                                                                "Part 4",
                                                                true, true),
                                                new ArmStateMachine(mShoulder, mWrist, mBelt, mIntake,
