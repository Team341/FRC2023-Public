...
public class TopTwoHalfBalanceFling extends SequentialCommandGroup {
        /** Creates a new RedBottom2Cycle. */
        public TopTwoHalfBalanceFling(Swerve mDrivebase, Shoulder mShoulder, Wrist mWrist, BeltDrivenExtension mBelt,
                        Intake mIntake, Catapult mCatapult, boolean isBlue) {

                addCommands(
                                new TopTwoHalfBalance(mDrivebase, mShoulder, mWrist, mBelt, mIntake, mCatapult, isBlue),
